...
const BIP39_WORDLIST = [
  ...
  "mouse", "move", "movie", "much", "muffin", "mug", "mulberry", "multiply", "muscle", "museum",
  ...
  "place", "planet", "plastic", "plate", "play", "pleasure", "pledge", "pluck", "plug", "plunge",
  ...
  "right", "rigid", "ring", "riot", "rip", "ritual", "rival", "river", "road", "roast",
  ...
  "table", "tackle", "tag", "tail", "talent", "talk", "tank", "tap", "target", "task",
  ...
  "vibrant", "vicious", "video", "view", "village", "vintage", "violin", "virtual", "virus", "visa",
